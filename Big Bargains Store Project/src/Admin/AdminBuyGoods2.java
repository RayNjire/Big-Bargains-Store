 ...
 * @author ray njire
 */
public class AdminBuyGoods2 extends javax.swing.JFrame
{
    ...
    */
    ...
    private void initComponents() {
        ...
        PNL1.add(LBLPrice1);
        LBLPrice1.setBounds(120, 350, 70, 30);
        ...
        PNL1.add(LBLLegos);
        LBLLegos.setBounds(350, 50, 200, 200);
        ...
        PNL1.add(LBLName2);
        LBLName2.setBounds(380, 310, 80, 30);
        ...
        PNL1.add(LBLPrice2);
        LBLPrice2.setBounds(440, 350, 90, 30);
        ...
        PNL1.add(BTNBuy2);
        BTNBuy2.setBounds(350, 400, 200, 30);
        ...
        LBLQuantity2.setBounds(380, 460, 70, 20);
        ...
        CBXItem2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CBXItem2ActionPerformed(evt);
            }
        });
        PNL1.add(CBXItem2);
        CBXItem2.setBounds(460, 450, 80, 30);
        ...
        LBLID3.setText("ID");
        PNL1.add(LBLID3);
        LBLID3.setBounds(660, 260, 80, 40);
        ...
        PNL1.add(LBLPrice3);
        LBLPrice3.setBounds(710, 350, 80, 30);
        ...
        PNL1.add(BTNBuy3);
        BTNBuy3.setBounds(640, 400, 190, 30);
        ...
        LBLQuantity3.setBounds(660, 460, 70, 20);
        ...
        PNL1.add(CBXItem3);
        CBXItem3.setBounds(749, 454, 80, 30);
        ...
        PNL1.add(BTNInCart);
        BTNInCart.setBounds(350, 520, 200, 40);
        ...
        LBLBackground.setBounds(-6, -6, 890, 610);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(PNL1, javax.swing.GroupLayout.PREFERRED_SIZE, 880, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void CBXItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CBXItem2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CBXItem2ActionPerformed
